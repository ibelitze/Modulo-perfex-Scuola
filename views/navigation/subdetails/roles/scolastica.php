 ...
 <!-- SCOLASTICA START -->
 <!-- ############################################################################################################ -->
 <?php if (staff_can('sec_escolastica', 'retiros')): ?>
 ...
 <div class="row wti-row scuola-director">
     ...
     <form id="wti_segre">
         <div class="col-md-12">
             <h3 class="wti-title-h3">Acciones del Segretario(a)</h3>
             <div class="form-group" app-field-wrapper="segre_msg_scolastica">
                 <label for="segre_msg_scolastica" class="control-label">
                     <small class="req text-danger">* </small>Enviar al responsable actual:</label>
                 <textarea name="segre_msg_scolastica" id="segre_msg_scolastica" rows="3" cols="30" required></textarea>
             </div>
             ...
             <button class="btn btn-info" id="submit_scolastica_send_mensaje">Enviar Mensaje</button>
         </div>
     </form>
 </div>
 <?php endif;?>
