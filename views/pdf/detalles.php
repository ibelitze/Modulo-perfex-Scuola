		    ...
		    <tr>
		        <td valign="top" style="padding:0;Margin:0">
		            <table class="es-content" cellspacing="0" cellpadding="0" align="center" style=";border-spacing:0px;table-layout:fixed !important;width:100%">
		                                ...
		                                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" style="border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:100%;">
		                                    <tr>
		                                        ...
		                                        <td valign="top" align="center" style="padding:0;Margin:0;width:100%;">
			                                        ...
			                                        <td width="50%" align="center" style="padding:0;Margin:0"><p style="text-align: left;Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px;color:#0dab0d;font-size:15px"><strong>Solicitud de retiro - Número de folio 87</strong></p></td>
			                                        </tr>
			                                    	</table>
		                                		</td>
		                            			</tr>
							                ...
							                <tr>
							                    <td width="50%" align="left" style="padding:0;Margin:0;padding-top:20px;padding-left:20px;padding-right:20px">
							                        ...
							                        <tr>
							                        <td align="left" style="padding:0;Margin:0"><p style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:28px;color:#0dab0d;font-size:9px"><strong>Estado:</strong></p></td>
							                        </tr>
							                        <tr>
			            ...
			            <tr>
			                <td align="center"style="padding:0px;Margin:0;width:100%;background-color:#69b969;">
			                    <p style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:12px;color:#1a5a3c;font-size:9px">Solicitud de retiro -Número de folio 32353- Firmado electrónicamente a través del correo -apoderado@clientes.com- desde la dirección ip 192.168.0.1 el 03/01/2023 12:25pm</p>
			                    <br>
			                </td>
			            </tr>
			            <tr>
